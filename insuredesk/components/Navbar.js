      ...
      <Container>
        ...
        <BSNavbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto gap-1 align-items-lg-center">
            <Link
              href="/home"
              className={`nav-link px-3 py-2 rounded-pill d-flex align-items-center gap-2 ${isActive('/home') ? 'fw-semibold' : ''
                }`}
              style={isActive('/home') ? {
                background: 'linear-gradient(135deg, #5B6CFF 0%, #7F8CFF 100%)',
            ...
            <Link
              href="/customers"
              className={`nav-link px-3 py-2 rounded-pill d-flex align-items-center gap-2 ${isActive('/customers') ? 'fw-semibold' : ''
                }`}
            ...
            <Link
              href="/customers/add"
              className={`nav-link px-3 py-2 rounded-pill d-flex align-items-center gap-2 ${isActive('/customers/add') ? 'fw-semibold' : ''
                }`}
